...
.print "Subquery: Instrument played by THEO MENGEL:"
.print "\n"
...
SELECT DISTINCT
	m.musician_name AS "MUSICIAN",
	count(DISTINCT b.band_id) num_bands,
	group_concat(distinct b.band_id) band_ids
FROM plays_in pi
JOIN band b
	ON b.band_id = pi.band_id
JOIN musician m
